(function (a) {
    a.fn.allofthelights = function (b) {
        ...
        return this.each(function () {
            ...
            function p() {
                a("#" + b.switch_id + "_off").css({top: j.top, left: j.left});
                a("#allofthelights_bg1").css({top: "0px", height: e.top, left: "0px", right: "0px"});
                a("#allofthelights_bg2").css({height: f, top: e.top, left: "0px", right: h - e.left});
                a("#allofthelights_bg3").css({height: f, top: e.top, right: "0px", bottom: "0px", left: e.left + g});
            ...
            var c = a(this), d = true, e = null, f = null, g = null, h = null, i = null, j = null,
                k = "#" + b.switch_id + "_off";
            if (b.is_responsive) {
                ...
                m.each(function () {
                    ...
                    var c = this.tagName.toLowerCase() == "object" || b.attr("height") ? b.attr("height") : b.height(),
                        d = b.attr("width") ? b.attr("width") : b.width(), e = c / d;
                    if (!b.attr("id")) {

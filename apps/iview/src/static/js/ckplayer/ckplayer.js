...
!(function () {
    ...
    var ckplayer = function (obj) {
        ...
        this.language = {
            ...
            downLoadShockwaveFlash: '点击下载启用FlashPlayer插件'
        };
    ...
    ckplayer.prototype = {
        ...
        embedSWF: function () {
            ...
            var html = '',
                ...
                src = '/static/ckplayer/ckplayer.swf';
            id = 'id="' + vid + '" name="' + vid + '" ';
            ...
            if (!this.checkShockwaveFlash()) {
                this.PD.innerHTML = '<p>' + this.language['noLoadShockwaveFlash'] + '</p><p><a href="https://get.adobe.com/cn/flashplayer/update/osx/" target="_blank" style="color:#FFFFFF">' + this.language['downLoadShockwaveFlash'] + '</a></p>';
